...
public class NPC extends GameObject implements Serializable {
	...
	private static final String CATEGORY = "npc";
	...
	public NPC(int posX, int posY, int width, int height) {
		super(posX, posY, width, height, DEFAULT_COLOR);
	}

	public NPC(int posX, int posY, int width, int height, Color color) {
